...
import com.rocky.systoon.research.entity.User;
import com.rocky.systoon.research.mapper.UserMapper;
...
public class UserService {
    ...
    private final static String SINGLE_USER_PREFIX = "tob-rocky-single-user:";
     ...
     * @return
     */
    private final static String ALL_USER_PREFIX ="tob-rocky-list-user";
     ...
     * @param userList 可见用户
     */
    private final static String USER_PREFIX = "tob-rocky-user:";
